...
% experimental info
IDs = {'102'; '103'; '104'; '105'; '107'; '108'; '109'; '110';...
 '111'; '112'; '114'; '115'; '119'; '120'; '122'; '123'; '124';...
 '125'; '126'; '127'; '129'; '130'; '131'; '132'; '133'; '135';...
...
for id=2:length(IDs)
    ...
    mkdir([paths.mri IDs{id} '\analysis_simple\'])
    SPMdir=[paths.mri IDs{id} '\analysis_simple\'];
...
%     else
    ...
    % cues
    model1{1}.spm.stats.fmri_spec.sess.cond(1).name = 'Cue_Correct';
    model1{1}.spm.stats.fmri_spec.sess.cond(1).onset = onsets{id,1}.cue_correct;
    model1{1}.spm.stats.fmri_spec.sess.cond(1).duration = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(1).tmod = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(1).pmod = struct('name', {}, 'param', {}, 'poly', {});
    model1{1}.spm.stats.fmri_spec.sess.cond(1).orth = 1;
    
    model1{1}.spm.stats.fmri_spec.sess.cond(2).name = 'Cue_Incorrect';
    model1{1}.spm.stats.fmri_spec.sess.cond(2).onset= onsets{id,1}.cue_wrong;
    model1{1}.spm.stats.fmri_spec.sess.cond(2).duration = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(2).tmod = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(2).pmod = struct('name', {}, 'param', {}, 'poly', {});
    model1{1}.spm.stats.fmri_spec.sess.cond(2).orth = 1;
    ...
    % feedbacks
    model1{1}.spm.stats.fmri_spec.sess.cond(3).name = 'Feedback_Correct';
    model1{1}.spm.stats.fmri_spec.sess.cond(3).onset = onsets{id,1}.fb_correct;
    model1{1}.spm.stats.fmri_spec.sess.cond(3).duration = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(3).tmod = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(3).pmod = struct('name', {}, 'param', {}, 'poly', {});
    model1{1}.spm.stats.fmri_spec.sess.cond(3).orth = 1;
    
    model1{1}.spm.stats.fmri_spec.sess.cond(4).name = 'Feedback_Incorrect';
    model1{1}.spm.stats.fmri_spec.sess.cond(4).onset= onsets{id,1}.fb_wrong;
    model1{1}.spm.stats.fmri_spec.sess.cond(4).duration = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(4).tmod = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(4).pmod = struct('name', {}, 'param', {}, 'poly', {});
    model1{1}.spm.stats.fmri_spec.sess.cond(4).orth = 1;
    ...
    % scenes
    model1{1}.spm.stats.fmri_spec.sess.cond(5).name = 'Scenes(Control)';
    model1{1}.spm.stats.fmri_spec.sess.cond(5).onset = onsets{id,1}.control;
    model1{1}.spm.stats.fmri_spec.sess.cond(5).duration = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(5).tmod = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(5).pmod = struct('name', {}, 'param', {}, 'poly', {});
    model1{1}.spm.stats.fmri_spec.sess.cond(5).orth = 1;
    ...
    % objects
    model1{1}.spm.stats.fmri_spec.sess.cond(6).name = 'Object_Correct';
    model1{1}.spm.stats.fmri_spec.sess.cond(6).onset= onsets{id,1}.obj_correct;
    model1{1}.spm.stats.fmri_spec.sess.cond(6).duration = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(6).tmod = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(6).pmod = struct('name', {}, 'param', {}, 'poly', {});
    model1{1}.spm.stats.fmri_spec.sess.cond(6).orth = 1;
    
    model1{1}.spm.stats.fmri_spec.sess.cond(7).name = 'Object_Incorrect';
    model1{1}.spm.stats.fmri_spec.sess.cond(7).onset = onsets{id,1}.obj_wrong;
    model1{1}.spm.stats.fmri_spec.sess.cond(7).duration = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(7).tmod = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(7).pmod = struct('name', {}, 'param', {}, 'poly', {});
    model1{1}.spm.stats.fmri_spec.sess.cond(7).orth = 1;
    ...
    % fixation
    model1{1}.spm.stats.fmri_spec.sess.cond(8).name = 'Fixation cross';
    model1{1}.spm.stats.fmri_spec.sess.cond(8).onset= onsets{id,1}.fixationX;
    model1{1}.spm.stats.fmri_spec.sess.cond(8).duration = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(8).tmod = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(8).pmod = struct('name', {}, 'param', {}, 'poly', {});
    model1{1}.spm.stats.fmri_spec.sess.cond(8).orth = 1; 
    ...
    % confidence rating
    model1{1}.spm.stats.fmri_spec.sess.cond(8).name = 'Confidence rating';
    model1{1}.spm.stats.fmri_spec.sess.cond(8).onset= onsets{id,1}.confidence;
    model1{1}.spm.stats.fmri_spec.sess.cond(8).duration = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(8).tmod = 0;
    model1{1}.spm.stats.fmri_spec.sess.cond(8).pmod = struct('name', {}, 'param', {}, 'poly', {});
    model1{1}.spm.stats.fmri_spec.sess.cond(8).orth = 1; 
...
%     end
    ...
    % contrast 
    cue_v_control                = [1 1 0 0 -2];
    cueCorrect_v_control         = [1 0 0 0 -1];
    cueCorrect_v_CueIncorrect    = [1 -1];
    ...
    ReplayStats{1}.spm.stats.con.spmmat = cellstr([paths.analysis IDs{id} '\analysis_simple\SPM.mat']);
    
    
    % contrasts
    
    ReplayStats{1}.spm.stats.con.consess{1}.tcon.name = 'Cue > Control';
    ReplayStats{1}.spm.stats.con.consess{1}.tcon.weights = cue_v_control;
    ReplayStats{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
    
    ReplayStats{1}.spm.stats.con.consess{2}.tcon.name = 'CueCorrect > control';
    ReplayStats{1}.spm.stats.con.consess{2}.tcon.weights = cueCorrect_v_control;
    ReplayStats{1}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
    
    ReplayStats{1}.spm.stats.con.consess{3}.tcon.name = 'CueCorrect > CueIncorrect';
    ReplayStats{1}.spm.stats.con.consess{3}.tcon.weights = cueCorrect_v_CueIncorrect;
    ...
    mkdir(['D:\work_backups\replay_dat\transmat\simpleModel\' IDs{id}])
    for ctr=1:3
        copyfile([paths.analysis IDs{id} '\analysis_simple\' strcat('con_',sprintf('%04d',ctr),'.nii')],...
            ['D:\work_backups\replay_dat\transmat\simpleModel\' IDs{id} '\' strcat('con_',sprintf('%04d',ctr),'.nii')])
    end
    copyfile([paths.mri IDs{id} '\preproc\meanafunc.nii'],...
            ['D:\work_backups\replay_dat\transmat\simpleModel\' IDs{id} '\meanfunc.nii'])
